...
Read the *[Installing mise: Your All-in-One Dev Tool Manager](https://github.com/easyscale-academy/learn_dev_tools_basic-project/tree/01-Install-Mise/)* tutorial, then install and configure mise from scratch inside a brand-new GitHub Codespace. Once everything is working, delete the Codespace to free up resources.
